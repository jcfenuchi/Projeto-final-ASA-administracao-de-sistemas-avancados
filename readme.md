...
<h3 style="text-align:center" >Olá Saudações, sou julio cesar. </a></h3>  
        <img class="hi" src="APACHE/site-LocalHost-Primos/icons/hi.gif" width="300" heigth="300" />      
...
<img src="APACHE/site-LocalHost-Primos/icons/php.png" alt="php" style="width:20%">
<img src="APACHE/site-LocalHost-Primos/icons/apache.png" alt="apache" style="width:20%">
<img src="APACHE/site-LocalHost-Primos/icons/MySQL-Logo.png" alt="mysql" style="width:20%">
<img src="APACHE/site-LocalHost-Primos/icons/docker.png" alt="docker" style="width:20%">
...
<p>no processo desenvolvimento foi dado um ambiente pelo professor com tudo instalado para cada aluno.
        ...
        <img src="APACHE/site-LocalHost-Primos/icons/pagina-de-login.png" alt="pagina domains" style="width:70%">
...
<p>↣tipo root -> localizados na tabela root_users o root pode criar/excluir dominios acessaveis, troca sua senha de login e dos administradores de dominio.</p>
            ...
            <img src="APACHE/site-LocalHost-Primos/icons/root_user.png" alt="pagina domains" style="width:70%">
            <img src="APACHE/site-LocalHost-Primos/icons/criando_mirai.png" alt="pagina domains" style="width:70%">
            <img src="APACHE/site-LocalHost-Primos/icons/new_painel.png" alt="pagina domains" style="width:70%">
            ...
            <img src="APACHE/site-LocalHost-Primos/icons/painel_of_mirai.png" alt="pagina domains" style="width:70%">
            <img src="APACHE/site-LocalHost-Primos/icons/create_user_in_mirai.png" alt="pagina domains" style="width:70%">
            <img src="APACHE/site-LocalHost-Primos/icons/after_create_user_in_mirai.png" alt="pagina domains" style="width:70%">
            ...
            <img src="APACHE/site-LocalHost-Primos/icons/login_with_user.png" alt="pagina domains" style="width:70%"><br>
            ...
            <img src="APACHE/site-LocalHost-Primos/icons/login_dm_mirai.png" alt="pagina domains" style="width:70%"><br>
...
<img class="hi" src="APACHE/site-LocalHost-Primos/icons/pikachu-sad-goodbye-vtr16falxzf2u06f.gif" width="300" heigth="300" />
